...
Before we'll start here is BOM.
...
#### 5. Pull it towards yourself, be careful and do not break off the part of the palmrest that goes under the screen. After lifting the freed palmrest, disconnect the touchpad connector and remove the palmrest.

![](media/9.jpg)
![](media/10.jpg)

#### 6. Now unscrew all the marked screws and remove the speakers, disconnect 1 display ribbon cable and the network card, you can also remove the RAM.

![](media/11.jpg)
![](media/12.jpg)

#### 7. After that you can disconnect 2 display ribbon cable, and usb covering. Also free all the wires going into the display matrix.

![](media/13.jpg)

#### 8. ​Now, while holding the display matrix, unscrew the 2 remaining screws and carefully remove it.
...
#### 14. Now we can finally remove the cage and get to the BIOS chips: U49 on 4MB where Intel ME is located, and the main U99 on 8MB where the BIOS is located.
