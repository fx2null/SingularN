...
6. Now unscrew all the marked screws and remove the speakers, disconnect 1 display ribbon cable and the network card, you can also remove the RAM. Also free all the wires going into the display matrix.
7. ​Now, while holding the display matrix, unscrew the 2 remaining screws and carefully remove it.
8. Now disconnect the power jack cable and the fan cable.
9. Remove the SSD/HDD and by pressing the ExpressCard dummy slot, remove it from the laptop.
